        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <Link href="/" className="mb-8 inline-block max-w-[160px]">
                  <span className="mb-9 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Wander Wild Adventures</span>
            ...
            <LinkGroup header="Quick Links">
              ...
              <NavLink link="/packages" label="Packages" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    href="#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; 2024 Wander Wild Adventures
                </p>
              </div>
            </div>
          </div>
